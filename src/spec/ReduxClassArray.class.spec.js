...
describe("ReduxClassArray.class", function() {
  ...
  describe("Object tree", () => {
    ...
    it("should set array in deeper objects", done => {
      ...
      expect(reducer.get("inner").get("obj3") instanceof ReduxClass).to.be
        .false;
      done();
    });
    ...
    it("should set array in deeper objects on new()", done => {
      ...
      expect(reducer2.get("inner").get("array") instanceof ReduxClassArray).to
        .be.true;
      expect(reducer2.get("inner").get("obj1") instanceof ReduxClass).to.be
        .true;
      expect(reducer2.get("inner").get("obj2") instanceof ReduxClass).to.be
        .true;
